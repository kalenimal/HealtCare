...
const patientProfiles: Record<string, PatientProfile> = {
  ...
  'p-4': {
    base: { kcal: 2900, steps: 4200, activityMinutes: 18, bpSystolic: 132, waterGlasses: 4 },
  ...
  'p-6': {
    base: { stressLevel: 4, waterGlasses: 6, activityMinutes: 38 },
    trendPerDay: { stressLevel: 0.045, activityMinutes: -0.08, waterGlasses: -0.015 },
    noise: {},
  },
};
